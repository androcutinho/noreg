              ...
              <div class="row w-full">
                ...
                <div class="col-md-auto col-sm-12">
                  <div class="ms-auto d-flex flex-wrap btn-list">
                    ...
                    <a href="postuplenie/form.php" class="btn btn-primary">Создать</a>
                  </div>
                </div>
              </div>
            </div>
                ...
                <tbody>
                  <?php if (!empty($products)): ?>
                    <?php foreach ($products as $product): ?>
                      <tr>
                        <td><a href="postuplenie/tovarov.php?product_id=<?= htmlspecialchars($product['id']) ?>" class="text-primary"><?= htmlspecialchars($product['id']) ?></a></td>
