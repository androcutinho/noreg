...
function createSpecification($mysqli, $data) {
    ...
    $stmt = $mysqli->prepare("
        ...
        (data_dogovora, nomer_specifikacii, gorod, nomer_dogovora, id_organizacii, id_kontragenti, usloviya_otgruzki, usloviya_oplaty, inye_usloviya, id_sotrudniki, podpisant_postavshchika_dolzhnost, podpisant_postavshchika_fio, utverzhden)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    ");
    $stmt->bind_param(
        'ssssiisssissi',
...
function getSpecificationById($mysqli, $spec_id) {
    ...
    $stmt = $mysqli->prepare("
        SELECT id, data_dogovora, nomer_specifikacii, gorod, nomer_dogovora, 
               ...
               podpisant_postavshchika_fio, utverzhden
