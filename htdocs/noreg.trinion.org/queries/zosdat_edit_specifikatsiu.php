...
function createSpecification($mysqli, $data) {
    ...
    $stmt = $mysqli->prepare("
        ...
        (data_dogovora, nomer_specifikacii, gorod, nomer_dogovora, id_organizacii,  id_kontragenti_pokupatel, usloviya_otgruzki, usloviya_oplaty, inye_usloviya, id_sotrudniki, podpisant_postavshchika_dolzhnost, podpisant_postavshchika_fio, id_index)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    ");
    $stmt->bind_param(
        'ssssiisssissi',
...
function getSpecificationById($mysqli, $spec_id) {
    ...
    $stmt = $mysqli->prepare("
        SELECT id, data_dogovora, nomer_specifikacii, gorod, nomer_dogovora, 
               id_organizacii, id_kontragenti_pokupatel, usloviya_otgruzki, usloviya_oplaty, 
...
function updateSpecificationLineItems($mysqli, $spec_id, $products) {
    ...
    // First, delete all existing line items by id_index
...
function deleteSpecification($mysqli, $spec_id) {
    ...
    try {
        ...
        // Delete all line items by id_index
