  ...
  <SOAP-ENV:Body>
    <apldef:submitApplicationRequest>
      ...
      <apl:application>
        ...
        <apl:issueDate>2026-09-25T15:58:20</apl:issueDate>
        <apl:data>
          <merc:getVetDocumentByUuidRequest>
            <merc:localTransactionId>a100053</merc:localTransactionId>
            <merc:initiator>
              <vd:login>roskin_dg_260119</vd:login>
            </merc:initiator>
            <bs:uuid>aa9cdb37-1da4-4313-86e5-3ff2949dc082</bs:uuid>
            <dt:enterpriseGuid>1b81e6cb-78fa-4244-a343-51dc7b354278</dt:enterpriseGuid>
          </merc:getVetDocumentByUuidRequest>
        </apl:data>
      </apl:application>
    </apldef:submitApplicationRequest>
