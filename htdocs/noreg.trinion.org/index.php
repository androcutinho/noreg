                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-truncate">
                                            <h3 class="card-title">
                                                <a href="spisok_tovarov.php" class="text-reset">Товары</a>
                                            </h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-truncate">
                                            <h3 class="card-title">
                                                <a href="admin_page.php" class="text-reset">Серии</a>
                                            </h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-truncate">
                                            <h3 class="card-title">
                                                <a href="users.php" class="text-reset">Пользователи</a>
                                            </h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-truncate">
                                            <h3 class="card-title">
                                                <a href="admin_page.php" class="text-reset">Администрация</a>
                                            </h3>
