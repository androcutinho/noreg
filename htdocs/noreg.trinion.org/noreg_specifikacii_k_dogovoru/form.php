...
$podpisant_postavshchika_fio = '';$utverzhden = 0;$line_items = [];
                ...
                <div class="row" style="margin-top: 20px;">
                    <div class="col-12">
                        <label class="form-check">
                            <input class="form-check-input" type="checkbox" name="utverzhden" value="1" <?= (isset($_POST['utverzhden']) ? $_POST['utverzhden'] : $utverzhden) ? 'checked' : '' ?>>
