...
<div class="page-body">
    <div class="container-fluid">
        <div style="text-align: right; margin-bottom: 10px;">
            <a href="form.php?product_id=<?= htmlspecialchars($product_id) ?>" class="btn btn-primary">
                Добавить
            </a>
        </div>
        <div class="card">
                        ...
                        <?php if (!empty($series)): ?>
                            <?php foreach ($series as $seria): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="form.php?seria_id=<?= htmlspecialchars($seria['id']) ?>" class="btn btn-sm btn-primary">Редактировать</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
