...
$total_products = getProductsCount($mysqli, '');
          ...
          <div class="card">
            <div class="card-header">
              <div class="row w-full">
                <div class="col">
                  <h3 class="card-title mb-0">Список товары</h3>
                    ...
                    <?php foreach ($products as $product): ?>
                      <tr>
                        ...
                        <td class="text-secondary">
                          <a href="redaktirovanie.php?tov_id=<?= htmlspecialchars($product['id']) ?>">Редактировать</a>
                          <span> | </span>
                          <a href="../serii/spisok.php?product_id=<?= htmlspecialchars($product['id']) ?>">Серии</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  <?php else: ?>
