                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-truncate">
                                            <h3 class="card-title">
                                                <a href="tovary/spisok.php" class="text-reset">Товары</a>
                                            </h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-truncate">
                                            <h3 class="card-title">
                                                <a href="tovary/spisok.php" class="text-reset">Серии</a>
                                            </h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-truncate">
                                            <h3 class="card-title">
                                                <a href="polzovateli/spisok.php" class="text-reset">Пользователи</a>
                                            </h3>
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-truncate">
                                            <h3 class="card-title">
                                                <a href="postuplenie/spisok.php" class="text-reset">Поступление товаров</a>
                                            </h3>
                                            <div class="text-secondary">П</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
