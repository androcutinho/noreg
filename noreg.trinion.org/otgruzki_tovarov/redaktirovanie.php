    ...
    if (!$error) {
        ...
        if (!$user_role) {
            ...
            if ($is_edit) {
                ...
                if ($result['success']) {
                    header("Location: prosmotr.php.php.php?id=" . $id);
                    exit;
                } else {
                    $error = $result['error'];
                }
                ...
                <table class="table table-vcenter card-table" id="tablitsaTovarov">
                    ...
                    <tbody id="productsBody">
                        ...
                        <tr class="tovar-row">
                            ...
                            <td>
                                <div class="search-container" style="position: relative;">
                                    <input class="form-control" type="text" name="tovary[<?= $row_index ?>][seria_name]" placeholder="Введите серию..." autocomplete="off" value="<?= htmlspecialchars($_POST['tovary'][$row_index]['seria_name'] ?? ($item['seria_name'] ?? '')) ?>">
                                    <input type="hidden" name="tovary[<?= $row_index ?>][seria_id]" class="seria-id" value="<?= htmlspecialchars($_POST['tovary'][$row_index]['seria_id'] ?? ($item['id_serii'] ?? '')) ?>">
                                </div>
                            </td>
                            <td>
                                <div class="search-container" style="position: relative;">
                            ...
                            <td>
                                <?php 
                                    $field_qty_value = $_POST['tovary'][$row_index]['kolichestvo'] ?? (isset($item['kolichestvo_ostatka']) && $item['kolichestvo_ostatka'] > 0 ? $item['kolichestvo_ostatka'] : (isset($item['kolichestvo']) ? $item['kolichestvo'] : '0'));
                                ?>
                            ...
                            <td>
                                <div class="search-container" style="position: relative;">
                                    <input class="form-control" type="text" name="tovary[<?= $row_index ?>][naimenovanie_sklada]" placeholder="Введите склад" autocomplete="off" value="<?= htmlspecialchars($_POST['tovary'][$row_index]['naimenovanie_sklada'] ?? ($item['naimenovanie_sklada'] ?? '')) ?>">
                                    <input type="hidden" name="tovary[<?= $row_index ?>][id_sklada]" class="sklad-id" value="<?= htmlspecialchars($_POST['tovary'][$row_index]['id_sklada'] ?? ($item['id_sklada'] ?? '')) ?>">
                                </div>
                            </td>
                            <?php endif; ?>
                        ...
                        <tr class="tovar-row">
                            ...
                            <td>
                                <div class="search-container" style="position: relative;">
                                    <input class="form-control" type="text" name="tovary[0][naimenovanie_serii]" placeholder="Введите ед." autocomplete="off">
