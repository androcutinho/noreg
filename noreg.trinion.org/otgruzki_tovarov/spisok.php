...
$summa_zakazy = getOtgruzkiCount($mysqli, $type);
...
$otgruzki = getAllOtgruzki($mysqli, $items_na_stranitse, $offset, $type);
            ...
            <div class="card-header">
              <div class="row w-full">
                <div class="col">
                  ...
                  <p class="text-secondary m-0">Всего отгрузок: <?= $summa_zakazy ?> штук.</p>
                </div>
                  ...
                  <?php else: ?>
                    <tr>
                      <td colspan="5" class="text-center text-secondary p-4">
                        Отгрузки еще не добавлены. <a href="redaktirovanie.php">Добавьте первую отгрузку</a>
                      </td>
                    </tr>
                  <?php endif; ?>
                </tbody>
