    ...
    if (!$error) {
        ...
        if (!$user_role) {
            ...
            if ($is_edit) {
                ...
                $result = obnovitDokument($mysqli, $id_tovara, $_POST);
                ...
                <table class="table table-vcenter card-table" id="tablitsaTovarov">
                    ...
                    <tbody id="tovaryBody">
                        ...
                        <tr class="tovar-row">
                            ...
                            <td><input class="form-control" type="text" name="tovary[<?= $row_index ?>][ostatok]" placeholder="0" autocomplete="off" value="<?= htmlspecialchars($submitted_item['ostatok'] ?? '') ?>"></td>
                            <td><input class="form-control" type="text" name="tovary[<?= $row_index ?>][ubavit]" placeholder="0" autocomplete="off" value="<?= htmlspecialchars($submitted_item['ubavit'] ?? '') ?>"></td>
                            <td><input class="form-control" type="text" name="tovary[<?= $row_index ?>][pribavit]" placeholder="0" autocomplete="off" value="<?= htmlspecialchars($submitted_item['pribavit'] ?? '') ?>"></td>
                        ...
                        <tr class="tovar-row">
                            ...
                            <td><input class="form-control" type="text" name="tovary[<?= $row_index ?>][ostatok]" placeholder="0" autocomplete="off" value="<?= htmlspecialchars($item['ostatok'] ?? '') ?>"></td>
                            <td><input class="form-control" type="text" name="tovary[<?= $row_index ?>][ubavit]" placeholder="0" autocomplete="off" value="<?= htmlspecialchars($item['ubavit'] ?? '') ?>"></td>
                            <td><input class="form-control" type="text" name="tovary[<?= $row_index ?>][pribavit]" placeholder="0" autocomplete="off" value="<?= htmlspecialchars($item['pribavit'] ?? '') ?>"></td>
                            <td><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-trash delete-row" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" onclick="deleteRow(this)"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M4 7l16 0"></path><path d="M10 11l0 6"></path><path d="M14 11l0 6"></path><path d="M5 7l1 12a2 2 0 0 0 2 2h8a2 2 0 0 0 2 -2l1 -12"></path><path d="M9 7v-3a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v3"></path></svg></td>
                        </tr>
                            <?php $row_index++; ?>
                            <?php endforeach; ?>
                        ...
                        <tr class="tovar-row">
                            ...
                            <td class="col-ostatok"><input class="form-control" type="text" name="tovary[0][ostatok]" placeholder="0" autocomplete="off" value="<?= htmlspecialchars($volume) ?>"></td>
