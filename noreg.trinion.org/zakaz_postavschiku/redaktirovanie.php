...
if ($is_edit) {
    ...
    $line_items = getZakazStrokiItems($mysqli, $document['id_index']);
    ...
    $id_postavschika = $document['id_kontragenti_postavshchik'] ?? '';
    $naimenovanie_organizacii = $document['naimenovanie_organizacii'] ?? '';
    $id_organizacii = $document['id_kontragenti_pokupatel'] ?? '';
    ...
    if (!$error) {
        ...
        if (!$user_role) {
            ...
            if ($is_edit) {
                ...
                $result = obnovitZakazDokument($mysqli, $zakaz_id, $_POST);
        ...
        <div class="card-body">
            <form method="POST" id="documentForm">   
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3" style="position: relative;">
                        <label class="form-label" for="id_organizacii">Покупатель</label>
