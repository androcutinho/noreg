...
if ($is_edit) {
    ...
    $line_items = fetchZakazLineItems($mysqli, $document['id_index']);
    ...
    $organization_id = $document['id_kontragenti_pokupatel'] ?? '';
    ...
    if (!$error) {
        ...
        if (!$user_role) {
            ...
            if ($is_edit) {
                ...
                $result = updateZakazDocument($mysqli, $zakaz_id, $_POST);
                ...
                // Create new document
                $result = createZakazDocument($mysqli, $_POST);
