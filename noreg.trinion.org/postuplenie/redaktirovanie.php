                ...
                <table class="table table-vcenter card-table" id="tablitsaTovarov">
                    ...
                    <tbody id="tovaryBody">
                        ...
                        <tr class="tovar-row">
                            ...
                            <td>
                                <div class="search-container">
                                    ...
                                    value="<?= htmlspecialchars($_POST['tovary'][$row_index]['naimenovanie_serii'] ?? ($item['naimenovanie_serii'] ?? '')) ?>">
                            ...
                            <td>
                                <div class="search-container" style="position: relative;">
                                    ...
                                    <input type="hidden" name="tovary[<?= $row_index ?>][id_edinitsii]" class="id-edinitsii" value="<?= htmlspecialchars($_POST['tovary'][$row_index]['id_edinitsii'] ?? ($item['id_edinitsii'] ?? '')) ?>">
                                </div>
                            </td>
                            <td><input class="form-control" type="text" name="tovary[<?= $row_index ?>][kolichestvo]" placeholder="0" autocomplete="off" value="<?= htmlspecialchars($_POST['tovary'][$row_index]['kolichestvo'] ?? ($item['kolichestvo'] ?? '')) ?>"></td>
                            ...
                            <td><input class="form-control" type="text" name="tovary[<?= $row_index ?>][summa_stavka]" placeholder="0" autocomplete="off" readonly value="<?= htmlspecialchars($_POST['tovary'][$row_index]['summa_stavka'] ?? ($item['suma_nds'] ?? '')) ?>"></td>
                            <td><input class="form-control" type="text" name="tovary[<?= $row_index ?>][summa]" placeholder="0" autocomplete="off" readonly value="<?= htmlspecialchars($_POST['tovary'][$row_index]['summa'] ?? ($item['obshchaya_summa'] ?? '')) ?>"></td>
                        ...
                        <tr class="tovar-row">
                            ...
                            <td><input class="form-control" type="text" name="tovary[0][kolichestvo]" placeholder="0" autocomplete="off" value="<?= htmlspecialchars($volume) ?>"></td>
                            ...
                            <td><input class="form-control" type="text" name="tovary[0][summa_stavka]" placeholder="0" autocomplete="off" readonly></td>
                            <td><input class="form-control" type="text" name="tovary[0][summa]" placeholder="0" autocomplete="off" readonly></td>
                            <td><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-trash delete-row" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" onclick="deleteRow(this)"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M4 7l16 0"></path><path d="M10 11l0 6"></path><path d="M14 11l0 6"></path><path d="M5 7l1 12a2 2 0 0 0 2 2h8a2 2 0 0 0 2 -2l1 -12"></path><path d="M9 7v-3a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v3"></path></svg></td>
                        </tr>
                        <?php endif; ?>
                    </tbody>
