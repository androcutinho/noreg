...
$page_title = 'Документ поступлення';
...
<div class="container-xl">
    <div class="row mb-3 d-print-none" style="margin-top: 30px;">
        <div class="col-auto ms-auto">
            <button type="button" class="btn btn-primary" onclick="window.location.href='form.php?uuid=<?php echo $uuid; ?>';"> Создать поступление</a>
            </button>
