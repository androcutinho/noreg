...
$summa_zakazy = getKolichestvoZakazy($mysqli);
...
$zakazy = getVceZakazyPokupatieliu($mysqli, $items_na_stranitse, $offset);
          ...
          <div class="card">
            <div class="card-header">
              <div class="row w-full">
                <div class="col">
                  <h3 class="card-title mb-0">Заказы покупателей</h3>
                  <p class="text-secondary m-0">Всего заказов: <?= $summa_zakazy ?> штук.</p>
                </div>
