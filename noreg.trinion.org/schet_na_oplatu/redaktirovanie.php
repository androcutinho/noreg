...
<div class="container-fluid mt-5">
    <h2 class="card-title fs-1 mt-2 mb3">
                ...
                <table class="table table-vcenter card-table" id="tablitsaTovarov">
                    ...
                    <tbody id="tovaryBody">
                        ...
                        <tr class="tovar-row">
                            ...
                            <td class="col-kolichestvo"><input class="form-control" type="text" name="tovary[<?= $row_index ?>][kolichestvo]" placeholder="0" autocomplete="off" value="<?= htmlspecialchars(isset($item['kolichestvo_ostatka']) && $item['kolichestvo_ostatka'] > 0 ? $item['kolichestvo_ostatka'] : (isset($item['kolichestvo']) ? $item['kolichestvo'] : '0')) ?>"></td>
