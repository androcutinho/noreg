                    ...
                    <?php foreach ($documents as $doc): ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <?php else: ?>
                            <a href="https://noreg.trinion.org/tovary/redaktirovanie.php?product_id=<?= $doc['id_tovary_i_uslugi'] ?>&prod_date=<?= urlencode($doc['dateOfProduction']) ?>&exp_date=<?= urlencode($doc['expiryDate']) ?>" class="btn btn-primary">
                              Создать
                            </a>
                          <?php endif; ?>
                        </td>
