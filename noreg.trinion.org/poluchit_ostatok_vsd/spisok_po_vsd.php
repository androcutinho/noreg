...
$result = getStockEntriesByVSD($mysqli);
            ...
            <div class="card-header">
                ...
                <div>
                  ...
                  <div class="d-flex">
                    ...
                    <a href="https://noreg.trinion.org/poluchit_ostatok_vsd/spisok_po_tovaram.php" class="btn">
                      По товарам
                    </a>
                  </div>
                </div>
                    ...
                    <?php foreach ($documents as $entry): ?>
                      <tr>
                        <td class="text-secondary" style="word-break: break-word;">
                          <?= htmlspecialchars($entry['predpriyataya_naimenovanie']) ?>
                        </td>
                        <td class="text-secondary" style="word-break: break-word;">
                          <?= htmlspecialchars($entry['naimenovanie_tovara']) ?>
                        </td>
                        <td class="text-secondary">
                          <?= htmlspecialchars($entry['vsd_uuid']) ?>
                        </td>
                        <td class="text-secondary">
                          <?= htmlspecialchars($entry['ostatok']) ?>
                        </td>
                        <td class="text-secondary">
                          <?= htmlspecialchars($entry['ed_naimenovanie']) ?>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  <?php else: ?>
