                    ...
                    <tbody id="productsBody">
                        <?php if (!empty($line_items)): ?>
                            <?php foreach ($line_items as $index => $item): ?>
                                <tr class="tovar-row">
                                    ...
                                    <td><input class="form-control" type="text" name="tovary[<?= $index ?>][kolichestvo]" placeholder="0" autocomplete="off" value="<?= $item['kolichestvo'] ?>"></td>
                                    <td><input class="form-control" type="text" name="tovary[<?= $index ?>][cena]" placeholder="0" autocomplete="off" value="<?= $item['cena'] ?>"></td>
                                    <td>
                                    ...
                                    <td><input class="form-control" type="text" name="tovary[<?= $index ?>][summa_stavka]" placeholder="0" autocomplete="off" value="<?= $item['summa_nds'] ?>"></td>
                                    <td><input class="form-control" type="text" name="tovary[<?= $index ?>][summa]" placeholder="0" autocomplete="off" value="<?= $item['summa'] ?>"></td>
                                    <td><input class="form-control" type="date" name="tovary[<?= $index ?>][planiruemaya_data_postavki]" value="<?= $item['planiruemaya_data_postavki'] ?>" required></td>
                        ...
                        <?php else: ?>
                            <tr class="tovar-row">
                                ...
                                <td><input class="form-control" type="date" name="tovary[0][planiruemaya_data_postavki]" required></td>
                                <td><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-trash delete-row" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round" onclick="deleteRow(this)"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M4 7l16 0"></path><path d="M10 11l0 6"></path><path d="M14 11l0 6"></path><path d="M5 7l1 12a2 2 0 0 0 2 2h8a2 2 0 0 0 2 -2l1 -12"></path><path d="M9 7v-3a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v3"></path></svg></td>
                                </tr>
                        <?php endif; ?>
                    </tbody>
